      ...
      <div className="min-h-screen bg-[#0a0a0a] text-white">
        <div className="mx-auto max-w-2xl px-6 py-20 lg:py-28 text-center">
          <div className="relative inline-flex mb-8">
            <div className="w-20 h-20 rounded-full border border-[#35D07F]/30 bg-[#35D07F]/8 flex items-center justify-center">
              <CheckCircle2 className="w-8 h-8 text-[#35D07F]" />
            </div>
            <div className="absolute inset-0 rounded-full bg-[#35D07F]/10 blur-xl animate-pulse" />
          </div>

          <span className="font-mono text-xs text-[#35D07F] uppercase tracking-widest mb-4 block">
            Verified
          </span>
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            <Link
              ...
              className="inline-flex items-center gap-2 bg-[#35D07F] text-black font-semibold px-7 py-3.5 rounded-full text-sm hover:bg-[#2bb86e] transition-colors"
            >
          ...
          {/* Address */}
          <div className="mt-12 border border-white/6 rounded-xl bg-[#0d0d0d] px-5 py-4 inline-block">
            <p className="text-xs text-white/30 font-mono mb-1 uppercase tracking-widest">Verified Address</p>
            <p className="text-xs font-mono text-[#35D07F] break-all">{address}</p>
          </div>
        </div>
      </div>
    );
    ...
    return (
      <div className="min-h-screen bg-[#0a0a0a] text-white">
        <div className="mx-auto max-w-2xl px-6 py-20 lg:py-28 text-center">
          ...
          {/* Timeline */}
          <div className="border border-white/6 rounded-xl bg-[#0d0d0d] p-6 text-left max-w-sm mx-auto mb-8">
            <div className="space-y-4">
              {[
                ...
                <div key={i} className="flex items-center gap-3">
                  <div className={`w-5 h-5 rounded-full border flex items-center justify-center shrink-0 ${done ? 'border-[#35D07F] bg-[#35D07F]/15' : 'border-white/15'}`}>
                    {done && <CheckCircle2 className="w-3 h-3 text-[#35D07F]" />}
                  </div>
          ...
          <div className="border border-white/6 rounded-xl bg-[#0d0d0d] px-5 py-4 inline-block">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-8 items-start">
          ...
          <div className="lg:col-span-3 space-y-4">
            ...
            {steps.map(({ num, title, desc }, i) => (
              <div
                key={num}
                className="border border-white/8 rounded-xl bg-[#0d0d0d] p-6 flex gap-5 group hover:border-white/14 transition-colors"
              >
                ...
                {i === 0 && (
                  <div className="ml-auto shrink-0 w-1.5 h-1.5 rounded-full bg-[#35D07F] mt-1.5 animate-pulse" />
                )}
              </div>
            ))}
          </div>
          ...
          <div className="lg:col-span-2 lg:sticky lg:top-24">
            <div className="border border-white/8 rounded-xl bg-[#0d0d0d] p-6 lg:p-7">
              <div className="flex items-center gap-3 mb-6">
                <div className="w-10 h-10 rounded-full border border-[#35D07F]/25 bg-[#35D07F]/6 flex items-center justify-center">
              ...
              <div className="space-y-3 mb-6">
                {["Free to submit", "Admin-reviewed", "Permanent on-chain"].map((f) => (
                  <div key={f} className="flex items-center gap-2.5">
                    <CheckCircle2 className="w-3.5 h-3.5 text-[#35D07F] shrink-0" />
              ...
              <button
                ...
                className="w-full inline-flex items-center justify-center gap-2 bg-[#35D07F] text-black font-semibold px-6 py-3.5 rounded-xl text-sm hover:bg-[#2bb86e] disabled:opacity-40 disabled:cursor-not-allowed transition-all"
              >
